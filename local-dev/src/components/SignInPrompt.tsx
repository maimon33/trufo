...
export default function SignInPrompt({ message = "Please sign in to continue" }: SignInPromptProps) {
    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white shadow-lg rounded-lg p-6 text-center">
        ...
        <p className="text-xs text-gray-500 mt-4">
          We only request basic profile information (name, email) with minimal permissions.
        </p>
      </div>
    </div>
  )
